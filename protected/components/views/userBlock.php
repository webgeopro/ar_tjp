            ...
            <td align="center" valign="center">
                <?if (!Yii::app()->user->isGuest):?>
                    <div class="gbUserGreeting">
                        Hello <?= empty($this->user['fullname'])
                            ? $this->user['username']
                            : $this->user['fullname'];?>!
                    </div>
                <?endif?>
                <div class="gbUserActions">
                    ...
                    <?else:?>
                        &nbsp;<a class="gbAdminLink gbLink-puzzle_MyPuzzles giTitle" href="<?=$this->userAlbumLink?>">My Puzzles</a>
                ...
                <?if ($this->isAlbum && $this->isOwner):?>
                    <?#if (0 <= Item::model()->count('owner_id=:ownerID', array(':ownerID'=>Yii::app()->user->id))):?>
                        <a href="/makeapuzzle<?=$this->albumUrl?>">
                            <img src="/images/make_a_puzzle_s.png" alt="Make a puzzle!" title="Make a puzzle!" width="160" height="29">
                        </a>
                    <?#endif?>
                <?endif?>
            </td>
