                                    ...
                                    <div class="one-image">
                                        <div class="giThumbnailContainer">
                                            ...
                                            <div class="giCutoutLabel">
                                                <img src="/images/cutouts/<?=$item['cut']['name']?str_replace(' ','_',$item['cut']['name']):str_replace(' ','_',Yii::app()->params['defaultCutout'])?>.png"
                                                     alt="<?=$item['cut']?$item['cut']['name']:Yii::app()->params['defaultCutout']?>"
                                                     title="<?=$item['cut']?$item['cut']['name']:Yii::app()->params['defaultCutout']?>" />
                                            </div>
                                        </div>
                ...
                <form action="" method="post" enctype="multipart/form-data" id="itemAdminForm">
                    ...
                    <div class="gbBlock">
                        <div style="clear:both">
                            <input type="checkbox" name="chItemDelete" id="<?$item['id']?>">
                            Delete this puzzle:
                            <a href="<?=$itemAddress?>">
                                <?=$item['componentUrl']?>
                            </a>
                        ...
                        <div style="float:left">
                            ...
                            <textarea id="description_<?=$item['id']?>" rows="4" cols="50"
                                      name="item[description]"><?=$item['attr']['description']?>
                            </textarea>
                            <h4> Default cut </h4>
                            <?=CHtml::dropDownList('cutout', $item['cutout'], $listCutout)?>
                        </div>
